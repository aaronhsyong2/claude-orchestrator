...
| 18 | "Review one last final round. If no issues, commit with branch prefix + issue number" | review/final-gate + commit | Round 6: APPROVE, 0 issues. Committing. | Orchestrator should support conditional commit — "review, then commit if clean" |
